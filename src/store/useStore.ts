...
import {
  ...
  BreathingSession, FinanceCategory, IncomeSource, BudgetCategory
} from '@/types';
...
// Default finance categories - фиксированные и переменные расходы
const defaultCategories: FinanceCategory[] = [
  // Фиксированные расходы
  { id: '1', name: 'Аренда/Ипотека', emoji: '🏠', budget: 30000, spent: 0, color: '#6366f1', isFixed: true },
  { id: '2', name: 'Коммунальные', emoji: '💡', budget: 5000, spent: 0, color: '#8b5cf6', isFixed: true },
  { id: '3', name: 'Интернет/Связь', emoji: '📶', budget: 2000, spent: 0, color: '#a855f7', isFixed: true },
  { id: '4', name: 'Подписки', emoji: '📱', budget: 2000, spent: 0, color: '#d946ef', isFixed: true },
  // Переменные расходы
  { id: '5', name: 'Продукты', emoji: '🛒', budget: 20000, spent: 0, color: '#10b981', isFixed: false },
  { id: '6', name: 'Транспорт', emoji: '🚗', budget: 8000, spent: 0, color: '#3b82f6', isFixed: false },
  { id: '7', name: 'Развлечения', emoji: '🎮', budget: 5000, spent: 0, color: '#f97316', isFixed: false },
  { id: '8', name: 'Кафе/Рестораны', emoji: '🍕', budget: 5000, spent: 0, color: '#ef4444', isFixed: false },
  { id: '9', name: 'Одежда', emoji: '👕', budget: 5000, spent: 0, color: '#ec4899', isFixed: false },
  { id: '10', name: 'Здоровье', emoji: '💊', budget: 3000, spent: 0, color: '#14b8a6', isFixed: false },
  { id: '11', name: 'Красота', emoji: '💅', budget: 3000, spent: 0, color: '#f472b6', isFixed: false },
  { id: '12', name: 'Другое', emoji: '📦', budget: 5000, spent: 0, color: '#6b7280', isFixed: false },
];

// Default income sources
const defaultIncomeSources: IncomeSource[] = [
  { id: 'salary', name: 'Зарплата', emoji: '💼', amount: 80000, type: 'salary', isMonthly: true, date: new Date().toISOString() },
  { id: 'advance', name: 'Аванс', emoji: '💵', amount: 20000, type: 'advance', isMonthly: true, date: new Date().toISOString() },
];

// Default budget categories (50/30/20 rule)
const defaultBudgetCategories: BudgetCategory[] = [
  // Needs (50%)
  { id: '1', name: 'Аренда/Ипотека', icon: '🏠', type: 'needs', percent: 25, spent: 0, color: '#3B82F6' },
  { id: '2', name: 'Коммунальные', icon: '💡', type: 'needs', percent: 5, spent: 0, color: '#60A5FA' },
  { id: '3', name: 'Продукты', icon: '🛒', type: 'needs', percent: 12, spent: 0, color: '#93C5FD' },
  { id: '4', name: 'Транспорт', icon: '🚗', type: 'needs', percent: 5, spent: 0, color: '#BFDBFE' },
  { id: '5', name: 'Связь/Интернет', icon: '📱', type: 'needs', percent: 3, spent: 0, color: '#DBEAFE' },
  // Wants (30%)
  { id: '6', name: 'Развлечения', icon: '🎬', type: 'wants', percent: 10, spent: 0, color: '#A855F7' },
  { id: '7', name: 'Кафе/Рестораны', icon: '🍕', type: 'wants', percent: 8, spent: 0, color: '#C084FC' },
  { id: '8', name: 'Одежда', icon: '👕', type: 'wants', percent: 5, spent: 0, color: '#D8B4FE' },
  { id: '9', name: 'Хобби', icon: '🎮', type: 'wants', percent: 4, spent: 0, color: '#E9D5FF' },
  { id: '10', name: 'Красота/Уход', icon: '💅', type: 'wants', percent: 3, spent: 0, color: '#F3E8FF' },
  // Savings (20%)
  { id: '11', name: 'Инвестиции', icon: '📈', type: 'savings', percent: 10, spent: 0, color: '#10B981' },
  { id: '12', name: 'Подушка безопасности', icon: '🛡️', type: 'savings', percent: 5, spent: 0, color: '#34D399' },
  { id: '13', name: 'Накопления', icon: '🎯', type: 'savings', percent: 5, spent: 0, color: '#6EE7B7' },
];
...
interface StoreActions {
  ...
  addBudgetExpense: (categoryId: string, amount: number) => void;
  ...
  persist(
    (set, get) => ({
      ...
      addIncomeSource: (income) => {
        ...
        set((state) => ({ incomeSources: [...state.incomeSources, newIncome] }));
      },
      ...
      addBudgetCategory: (category) => {
        ...
        set((state) => ({ budgetCategories: [...state.budgetCategories, newCategory] }));
      },
      ...
      addBudgetExpense: (categoryId, amount) => {
        set((state) => ({
          budgetCategories: state.budgetCategories.map((c) =>
